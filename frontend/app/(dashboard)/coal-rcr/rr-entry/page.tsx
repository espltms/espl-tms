    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">
          Log Railway Receipts (RR), wagon counts, indents, and freight invoice records
        </p>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm flex flex-col items-center justify-center text-center max-w-3xl mx-auto min-h-[350px]">
        ...
        <h3 className="text-base font-bold text-slate-800 uppercase tracking-wider">RR Entry Configuration Pending</h3>
        <p className="text-xs text-slate-500 mt-2 max-w-md">
          This section will hold your Railway Receipts (RR) registry (log wagon counts, indents, invoice weights, and freight cost details). We are waiting for your input details to define the columns and fields.
        </p>
