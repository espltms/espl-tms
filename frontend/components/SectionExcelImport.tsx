...
const SECTION_COLUMN_ALIASES: Record<string, string[]> = {
  ...
  'RR Entry': [
    ...
    'siding', 'siding name', 'source siding', 'source_siding',
    'rr no', 'rr number', 'rr_no', 'railway receipt',
    'rr date', 'rr_date',
    'loading date', 'loading_date',
    'receipt date', 'receipt_date',
    'rr act qty', 'rr actual quantity', 'actual quantity', 'rr_act_qty', 'rr actual qty',
    'rr ch qty', 'rr charged quantity', 'charged quantity', 'chrg qty', 'rr charged qty', 'rr_ch_qty',
    'vll qty', 'vll quantity', 'vll', 'vll_qty',
    'grn qty', 'grn quantity', 'grn', 'grn_qty',
    'normalised qty', 'normalized qty', 'normalised_qty',
    'fnr no', 'fnr number', 'fnr_no', 'fnr', 'fnr_number',
    'in motion qty', 'in_motion_qty', 'in motion weight', 'in motion quantity',
    'espl t inv no', 'espl (t) inv no', 'espl t invoice no', 'espl(t)invno',
    'espl h inv no', 'espl (h) inv no', 'espl h invoice no', 'espl(h)invno',
    'date', 'inv date', 'invoice date',
    't inv amt', 't_inv_amt', 't inv amount', 't invoice amount',
    'h inv amt', 'h_inv_amt', 'h inv amount', 'h invoice amount',
    'pol1', 'pol1/a', 'pol 1', 'pol1a',
    'pol2', 'pol 2',
    'enhc',
    'dcla',
    'fauc',
